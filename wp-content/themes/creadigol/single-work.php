...
<article class="case">
	...
	<dl class="section case__facts">
		<?php if ( $client ) : ?><div><dt class="eyebrow">Cleient / Client</dt><dd><?php echo esc_html( $client ); ?></dd></div><?php endif; ?>
		<?php if ( $year ) : ?><div><dt class="eyebrow">Blwyddyn / Year</dt><dd><?php echo esc_html( $year ); ?></dd></div><?php endif; ?>
		<?php if ( $tags ) : ?><div><dt class="eyebrow">Disgyblaethau / Disciplines</dt><dd><?php echo esc_html( implode( ' · ', $tags ) ); ?></dd></div><?php endif; ?>
		<?php if ( has_excerpt() ) : ?><div><dt class="eyebrow">Allbynnau / Deliverables</dt><dd><?php echo esc_html( get_the_excerpt() ); ?></dd></div><?php endif; ?>
	</dl>
	...
	<?php if ( $quote ) : ?>
		<section class="section case__quote">
			<?php creadigol_eyebrow( 'Canlyniad', 'Outcome' ); ?>
			<blockquote>
	...
	<?php if ( $creds ) : ?>
		<section class="section case__credits">
			<?php creadigol_eyebrow( 'Credydau', 'Credits' ); ?>
			<dl class="credits">
	...
	<?php if ( $next ) : ?>
		<section class="section case__next">
			<?php creadigol_eyebrow( 'Nesaf', 'Next project' ); ?>
